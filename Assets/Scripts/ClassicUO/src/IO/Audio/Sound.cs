...
namespace ClassicUO.IO.Audio
{
    internal abstract class Sound : IComparable<Sound>, IDisposable
    {
        ...
        public bool IsPlaying => _sound_instance != null && _sound_instance.State == DynamicSoundEffectInstance.SoundState.Playing;
        ...
        private void CullExpiredEffects(double now)
        {
            ...
            {
                if (m_EffectInstances[i].Item1.IsDisposed || m_EffectInstances[i].Item1.State == DynamicSoundEffectInstance.SoundState.Stopped || m_EffectInstances[i].Item2 <= now)
                {
            ...
            {
                if (m_MusicInstances[i].Item1.IsDisposed || m_MusicInstances[i].Item1.State == DynamicSoundEffectInstance.SoundState.Stopped)
                {
