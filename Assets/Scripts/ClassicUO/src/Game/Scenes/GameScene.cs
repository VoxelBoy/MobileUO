...
namespace ClassicUO.Game.Scenes
{
    internal partial class GameScene : Scene
    {
        ...
        //NOTE: Coulnd't get world rendering to work properly with the matrices when this is set to false so we leave it as true for now
        ...
        public override bool Draw(UltimaBatcher2D batcher)
        {
            ...
            if (_use_render_target)
            {
                ...
                //NOTE: Batcher scale needs to be reverted here so that the _world_render_target can be drawn to fill the WorldViewport
