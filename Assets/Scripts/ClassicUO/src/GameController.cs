...
namespace ClassicUO
{
    internal unsafe class GameController : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            // File.WriteAllBytes(Path.Combine(UnityEngine.Application.persistentDataPath, "hue1.png"), UnityEngine.ImageConversion.EncodeToPNG(_hueSamplers[0].UnityTexture as UnityEngine.Texture2D));
            // File.WriteAllBytes(Path.Combine(UnityEngine.Application.persistentDataPath, "hue2.png"), UnityEngine.ImageConversion.EncodeToPNG(_hueSamplers[1].UnityTexture as UnityEngine.Texture2D));
        ...
        private void UnityInputUpdate()
        {
            ...
            if (UnityEngine.Application.isMobilePlatform && UserPreferences.UseMouseOnMobile.CurrentValue == 0)
            {
                ...
                {                    
                    ...
                    {
                        zoomCounter = 0;
                        Client.Game.GetScene<GameScene>().Camera.ZoomIndex--;
                    }
